...
class ply : public entity{
        ...
        public:
				...
				/*
					Desc: checks edgeList to see if it alread contains an edge
				*/
				bool containsEdge(edge* nextEdge);

				/*
					Desc: returns the index of edge. If edge doesn't exist return -1
				*/
				int indexOfEdge(edge* loc);
        ...
        private:
                ...
                int faceCount;
				// Stores the number of edges added
				int edgeCount;
