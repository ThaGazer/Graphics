/*   =================== File Information =================
    ...
    Description: add a file browser to the GLUI main menu
...
void control_cb( int control )
{
	...
	else if (control == MYBUT_ID)
	{
		//new GLUI->add_checkbox(0,0,0,1);
...
int main(int argc, char* argv[])
{
    ...
    */
	 ...
	 * add a ply sub list
	 */
	GLUI_Rollout* files = new GLUI_Rollout(glui, "Files", false);
	new GLUI_FileBrowser(files, "browser", MYBUT_ID, false, control_cb);
